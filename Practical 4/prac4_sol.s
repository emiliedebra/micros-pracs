...
_start:
    ...
    LDR R2, =0x00060000                 @ mask GPIOA and GPIOB bits in
    ORRS R1, R1, R2                     
    ...
    LDR R2, =0x00005555                 @ pattern of bits to rasie indicating pins 0 to 7 outputs
    ...
    LDR R2, =0xFFFFFF00                 @ mask out LSB to set it to 0
    ANDS R1, R1, R2
